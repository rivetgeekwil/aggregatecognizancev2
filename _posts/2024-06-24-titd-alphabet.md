...
{{< figure src="./symbols.png" width=250px alt="Sun, Moon, and Doomsayer Symbol" class="center" >}}
...
{{< figure src="./more-symbols.png" width=500px alt="Katana, cuneiform, percent, shell, and Catholic symbol(?) " class="center" >}}
