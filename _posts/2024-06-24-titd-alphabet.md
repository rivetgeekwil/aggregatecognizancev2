...
image:
  path: tablets.png
media_subpath: /assets/img/posts/titd-alphabet
---

While we were going through assets that Robert Dubois (the guy in charge at [Dream Pod 9](https://www.dp9.com)) had found, he unveiled a treasure trove of graphic design work dedicated to the Tribe 8 RPG. This included fonts, multiple versions of various symbols, photos used for textures that appear in the books, and...alphabets.

<figure class="d-block mx-auto text-center" style="max-width:250px">
  <img src="{{ '/assets/img/posts/titd-alphabet/symbols.png' | relative_url }}" width="250" alt="Sun, Moon, and Doomsayer Symbol">
</figure>
